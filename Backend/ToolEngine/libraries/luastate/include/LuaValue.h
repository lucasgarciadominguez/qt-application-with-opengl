...
namespace lua {
    ...
    public:
        ...
        void setData(K key, const char* value, size_t length) const {
            stack::push(_stack->state, key);
            stack::push_str(_stack->state, value, int(length));
            lua_settable(_stack->state, _stack->top + _stack->pushed - _stack->grouped);
        }
        ...
        int length() const {
            ...
            return (int)lua_rawlen(_stack->state, _stack->top + _stack->pushed - _stack->grouped);
#else
            return (int)lua_objlen(_stack->state, _stack->top + _stack->pushed - _stack->grouped);
#endif
        }
